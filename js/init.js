/*
  ...
  ***
  ...
  @author: Savaş Can ALTUN < savascanaltun.com.tr - savascanaltun@gmail.com - github.com/saltun >
*/
...
//			obj.attr(attributes).attr( { fill: "#000" } ); /* set blank colour */
		...
		{				
			...
			var seciliil=arr[this.id];
			
			$.post('ajax_harita.php', {il:seciliil}, function(gelen) {
				$("#detail").empty().fadeIn(700).append(gelen).css("display", "block");	
			});
			/* SKAYA - skayadev.com */
